...
sigma7 = 2.6;     % Recovery rate for infected individuals
sigma8 = 0.34;    % Recovery rate for exposed individuals
sigma9 = 0.68;    % Recovery rate for hospitalized individuals
...
f6 = @(t,S,V,E,I,H,R) h^alpha * (sigma6*H-(sigma7 + sigma2)*R);
